...
In Fig.~\ref{fig:glasses_all_subs} (Fig.~\ref{fig:basket_all_subs}) we show the results of the partial charge measurements with respect to all four-element subgroups of $D_4$ in the anyon fusion experiment on the braiding ladder (small planar graph).
