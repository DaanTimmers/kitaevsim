...
\section{Reduced Charge Measurement Additional Data}\label{app:more_data}

In this appendix, we show the results of the reduced charge measurements with respect to all four elements subgroups of $D_4$ in our anyon fusion experiment.
These results were left out of the main text for the sake of conciseness, however, if one doesn't want to rely on the knowledge of the fusion algebra to label the peaks in peaks in the histograms shown in Figure~\ref{fig:red_charge_res}, these results are necessary and sufficient as argued in the Section~\ref{sec:redchmmt}. The results for the fusion on the braiding ladder are shown in Figure~\ref{fig:glasses_all_subs} and for the small planar graph in Figure~\ref{fig:basket_all_subs}.
...
\begin{figure}
    ...
    \end{subfigure}
    \caption{The results of the reduced charge measurements for different four element subgroups of $D_4$ at the end of the fusion protocol done on the braiding ladder.}
