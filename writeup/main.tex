...
This equation informs a choice of basis that has nothing to do with the local spin-like variables and is spanned by all fusion outcomes $(c, d)$ for which none of the algebra coefficient in Eq.~\eqref{eqn:decomp} vanish, $$\mathcal{H}_{\text{deg.}} = \mathcal{H}_{\text{fusion}} = \text{span}\{\ket{c,d; e, 0}\},$$
