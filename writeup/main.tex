...
\end{enumerate}
where we say that the first group element controls the multiplication. It is this first group element that can be restricted to be in one of the following, useful, subsets of the full group $\{G\text{(Unrestricted)}, H_m, H_r, H_{mr}, C_m, C_r, C_{mr}\}$.
