...
The four different kinds of controlled multiplications are:\begin{enumerate}
...
In the Appendix~\ref{app:ribs} we see that we need four variants of the map, applying one of the controlled operations $\{A^{(T)}(g^{\pm 1})\}$. Figure~\ref{fig:GConj_scheme} schematically shows the form of the relevant circuits, though they are to be supplemented by appropriate unitaries from Table~\ref{tab:reps} depending on the label of the ribbon.
