...
The ribbon operators are constructed in Ref \cite{Kitaev_2003,cui2018topological}. These operators represent a planar diagram algebra generated by the specific Braiding Tensor Category (BTC) and hence were conceived as a model that can perform fault-tolerant quantum computing by the means of braiding anyons. 
