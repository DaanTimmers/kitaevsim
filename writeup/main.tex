...
However, we must remember that in the protocol for applying the ribbon operators, we need to project all the auxiliary qubits into appropriate Bell pair states $\ket{\Phi^+}$.
