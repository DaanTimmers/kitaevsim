...
For example, let us take the charge content of the gauge filed to be four anyon of the same type $a$ occupying four sites and look at the form of the degenerate subspace $\mathcal{H_{\text{deg.}}}}$.
...
$$\mathcal{H}_{\text{deg.}} = \mathcal{H}_{\text{fusion}} = \text{span}\{\ket{c,d; e, 0}\}.$$
...
Lastly, braiding of anyons doesn't change the charge content, hence, it must act within this degenerate space. Therefore, the degeneracy must be non-trivial and anyons Non-abelian for their braiding to have any computational power and its action is best described in the fusion basis in terms of topological variables such as $F$- and $R$-symbols \cite{cui2018topological, Kitaev_2003}. See Appendix \ref{app:braid} for the treatment of braiding of quantum double anyons in both local and fusion basis.
