...
The (abelian) fusion algebra of the excitations of this theory is highly symmetrical and can be broken down into the following set of rules:\begin{enumerate}
	...
	\end{enumerate}
	Note: this is not a symmetry of the algebra, just an observation, it is not true for pairs of involving $\Psi_x$ and $\tilde\Psi_x$, for $x \in \{m, r, mr\}$. The fusion rules for this subspace are reported in point 5.a.
\end{enumerate}
