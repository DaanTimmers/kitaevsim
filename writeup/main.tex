...
\begin{figure}
    \centering
    \includegraphics[width= \linewidth]{Figures/ribbon_examp.pdf}
    \caption{An example of a ribbon between site $s_1$ and $s_2$. The ribbon is made up from six Type I elementary triangles and two Type II elementary triangles, they are labelled.}
