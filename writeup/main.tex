...
The (abelian) fusion algebra of the excitations of this theory is highly symmetrical and can be broken down into the following set of rules:\begin{enumerate}
	...
	\item Rules relating to Abelian charges $\Sigma_x$, for $x \in\{m, r, mr\}$:\begin{enumerate}
		\item $\Sigma_x \otimes \Sigma_y = \Sigma_{\lfloor xy \rfloor}$, for $ y \in \{m, r, mr\}$ and where the $\lfloor \rfloor: G \rightarrow \{m , r, mr\} \equiv G/Z(G)$ divides out $r^2$ when necessary,
	...
	\end{enumerate}
	Note: this is not a symmetry of the algebra, just an observation, there are pairs of fusion rules that do not obey this relation and they are listed separately (e.g. point 5.a), hence this should only be used to generate rules that aren't already listed.
\end{enumerate}
