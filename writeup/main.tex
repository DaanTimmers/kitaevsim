...
Given the noise levels present in the simulator we resorted to the more simple $m$-dyons for most parts. However, the twist phase interferometry experiment was performed for the most complicated anyon, the $\Phi_r$ semion or its antisemion $\tilde \Phi_r$, in order to demonstrate a nontrivial twist phase.
