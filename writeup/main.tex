...
In the case of three dimensional anyons, the one with $\mathcal{C}_m$-flux base, we can reduce the number of Toffoli gates to 5 in the case of right and 2 in the case of left controlled multiplication. The conjugacy class is encoded with two qubits with one disallowed state, same as for the general group element.

Having access to qutrits again trivialises the problem.

The generalised conjugations 
