...
The number of runs for the fusion on the small planar graph was $64000$. The expected post-selection probability for the two ribbons is $1/16$, while the actual number of successes was $5289$, due to the circuit noise and measurement readout bias. The four main bins count $450(20)$ with the biggest noise peak being $242(15)$.
\emph{Braiding.}
